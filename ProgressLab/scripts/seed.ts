...
const exerciseSeed = [
	...
	{ name: 'Incline Bench Press', category: 'push', muscleGroup: 'Brust', isBodyweight: false, defaultRepTarget: 6, defaultRpeTarget: 7 },
	{ name: 'Incline DB Press', category: 'push', muscleGroup: 'Brust', isBodyweight: false, defaultRepTarget: 10, defaultRpeTarget: 8 },
	{ name: 'Dips', category: 'push', muscleGroup: 'Brust', isBodyweight: true, defaultRepTarget: 10, defaultRpeTarget: 8 },
	// --- Push: Schulter ---
	{ name: 'Overhead Press', category: 'push', muscleGroup: 'Schulter', isBodyweight: false, defaultRepTarget: 5, defaultRpeTarget: 7 },
	{ name: 'Lateral Raise', category: 'push', muscleGroup: 'Schulter', isBodyweight: false, defaultRepTarget: 12, defaultRpeTarget: 8 },
	// --- Push: Trizeps ---
	{ name: 'Close-Grip Bench Press', category: 'push', muscleGroup: 'Trizeps', isBodyweight: false, defaultRepTarget: 8, defaultRpeTarget: 8 },
	{ name: 'Triceps Pushdown', category: 'push', muscleGroup: 'Trizeps', isBodyweight: false, defaultRepTarget: 12, defaultRpeTarget: 8 },
	...
	{ name: 'Lat Pulldown', category: 'pull', muscleGroup: 'Rücken', isBodyweight: false, defaultRepTarget: 10, defaultRpeTarget: 8 },
	{ name: 'Cable Row', category: 'pull', muscleGroup: 'Rücken', isBodyweight: false, defaultRepTarget: 10, defaultRpeTarget: 8 },
	// --- Pull: Bizeps / Rear Delts ---
	{ name: 'Barbell Curl', category: 'pull', muscleGroup: 'Bizeps', isBodyweight: false, defaultRepTarget: 10, defaultRpeTarget: 8 },
	{ name: 'Hammer Curl', category: 'pull', muscleGroup: 'Bizeps', isBodyweight: false, defaultRepTarget: 12, defaultRpeTarget: 8 },
	{ name: 'Face Pull', category: 'pull', muscleGroup: 'Schulter', isBodyweight: false, defaultRepTarget: 15, defaultRpeTarget: 7 },

	// --- Legs: Quads ---
	{ name: 'Back Squat', category: 'legs', muscleGroup: 'Quads', isBodyweight: false, defaultRepTarget: 5, defaultRpeTarget: 7 },
	{ name: 'Front Squat', category: 'legs', muscleGroup: 'Quads', isBodyweight: false, defaultRepTarget: 6, defaultRpeTarget: 7 },
	{ name: 'Leg Press', category: 'legs', muscleGroup: 'Quads', isBodyweight: false, defaultRepTarget: 10, defaultRpeTarget: 8 },
	{ name: 'Walking Lunge', category: 'legs', muscleGroup: 'Quads', isBodyweight: false, defaultRepTarget: 10, defaultRpeTarget: 8 },
	// --- Legs: Hamstrings / Glutes ---
	{ name: 'Romanian Deadlift', category: 'legs', muscleGroup: 'Hamstrings', isBodyweight: false, defaultRepTarget: 8, defaultRpeTarget: 7 },
	{ name: 'Leg Curl', category: 'legs', muscleGroup: 'Hamstrings', isBodyweight: false, defaultRepTarget: 12, defaultRpeTarget: 8 },
	{ name: 'Hip Thrust', category: 'legs', muscleGroup: 'Glutes', isBodyweight: false, defaultRepTarget: 8, defaultRpeTarget: 8 },
	// --- Legs: Waden ---
	{ name: 'Standing Calf Raise', category: 'legs', muscleGroup: 'Waden', isBodyweight: false, defaultRepTarget: 12, defaultRpeTarget: 8 }
];
...
async function main() {
	...
	const history = [
		...
		{ ex: 'Incline DB Press', sessions: [
			{ d: 21, sets: [{ w: 22.5, r: 10, rpe: 7 }, { w: 22.5, r: 10, rpe: 8 }, { w: 22.5, r: 9, rpe: 8 }] },
			{ d: 7,  sets: [{ w: 25, r: 10, rpe: 7 }, { w: 25, r: 10, rpe: 8 }, { w: 25, r: 9, rpe: 8 }] }
		] },
		// Lateral Raise – Isolation, hohe Reps
		{ ex: 'Lateral Raise', sessions: [
			{ d: 21, sets: [{ w: 8, r: 12, rpe: 7 }, { w: 8, r: 12, rpe: 8 }, { w: 8, r: 10, rpe: 8 }] },
			{ d: 7,  sets: [{ w: 10, r: 12, rpe: 8 }, { w: 10, r: 11, rpe: 8 }, { w: 10, r: 10, rpe: 9 }] }
		] },
		// Triceps Pushdown
		{ ex: 'Triceps Pushdown', sessions: [
			{ d: 21, sets: [{ w: 25, r: 12, rpe: 7 }, { w: 25, r: 12, rpe: 7 }, { w: 25, r: 10, rpe: 8 }] },
			{ d: 7,  sets: [{ w: 27.5, r: 12, rpe: 7 }, { w: 27.5, r: 12, rpe: 8 }, { w: 27.5, r: 11, rpe: 8 }] }
		] },
		// Barbell Curl
		{ ex: 'Barbell Curl', sessions: [
			{ d: 21, sets: [{ w: 30, r: 10, rpe: 7 }, { w: 30, r: 10, rpe: 8 }, { w: 30, r: 8, rpe: 8 }] },
			{ d: 7,  sets: [{ w: 32.5, r: 10, rpe: 7 }, { w: 32.5, r: 9, rpe: 8 }, { w: 32.5, r: 8, rpe: 9 }] }
		] },
		// Face Pull
		{ ex: 'Face Pull', sessions: [
			{ d: 7, sets: [{ w: 20, r: 15, rpe: 7 }, { w: 20, r: 15, rpe: 7 }, { w: 20, r: 15, rpe: 7 }] }
		] },
		// Leg Press
		{ ex: 'Leg Press', sessions: [
			{ d: 14, sets: [{ w: 180, r: 10, rpe: 7 }, { w: 180, r: 10, rpe: 8 }, { w: 180, r: 9, rpe: 8 }] },
			{ d: 4,  sets: [{ w: 190, r: 10, rpe: 7 }, { w: 190, r: 10, rpe: 8 }, { w: 190, r: 8, rpe: 9 }] }
		] },
		// Leg Curl
		{ ex: 'Leg Curl', sessions: [
			{ d: 14, sets: [{ w: 35, r: 12, rpe: 7 }, { w: 35, r: 12, rpe: 8 }, { w: 35, r: 10, rpe: 8 }] },
			{ d: 4,  sets: [{ w: 37.5, r: 12, rpe: 7 }, { w: 37.5, r: 11, rpe: 8 }, { w: 37.5, r: 10, rpe: 9 }] }
		] },
		// Standing Calf Raise
		{ ex: 'Standing Calf Raise', sessions: [
			{ d: 4, sets: [{ w: 80, r: 12, rpe: 7 }, { w: 80, r: 12, rpe: 8 }, { w: 80, r: 12, rpe: 8 }] }
		] }
	];
